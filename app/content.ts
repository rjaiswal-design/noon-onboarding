...
export const modules: Module[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Each of the four records one filmed-and-edited case study — reused for every future joiner, so they become a permanent artifact. Every video answers the same five questions: a project worth knowing about; the problem and how it was framed; the hardest decision and why; what it taught them about working at noon specifically; and what they’d do differently starting it today.",
      },
      {
    ...
    sections: [
      {
        ...
        body: "A documented Figma structure: folder hierarchy (by POD, project, status), file-cover naming convention, internal naming (frames, components, versions), and status tags — exploration, in review, shipped. Finalised with Ayaneshu.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "Day 4 — the Design Lead takes the self-study and applies it: walks through one or two real examples where the archetype framing changed the decision, poses a small scenario and asks you to reason through which archetype and component, then opens Q&A.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    owners: ["POD seniors"],
    summary:
      "For your POD: existing features, PRDs, and 3–5 benchmark companies. A light-touch scan of the others.",
    sections: [
      {
        heading: "Intent",
      ...
      },
      {
        ...
        body: "Storefront, Monetization, Cart & Checkout, Customer. Each pack contains: existing features (navigate the product with context), PRDs (how product and design conversations happen at noon), and 3–5 benchmark companies with a short note on what each does well.",
      },
      {
        heading: "Depth strategy",
        body: "Go deep on the POD you’re placed in; light-touch scan the other three so you can hold a conversation about any of them. Designers here work across POD boundaries — an onboarding that produces silos is a failed onboarding. Each pack is owned by someone inside that POD, so it stays living and accurate.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        heading: "Intent",
        body: "A broader program with two pillars: hosted events bringing industry leaders into the noon design space alongside noon designers showing their own work; and PR for design leads — talks, articles, podcasts, social presence. Both point the same way: the noon design team is known, and you feel it the moment you arrive.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "This doesn’t end with onboarding. A shared resource program — books on product and design, podcasts (including outside the discipline), long-form on how product companies made specific decisions, internal references — on a regular cadence, everyone contributing and consuming. It answers a quiet question: what does it look like to grow at noon? You don’t stop learning.",
      },
    ],
  },
];
...
export const dependencies = [
  ...
  },
  {
    ...
    body: "Books, podcasts, references — a regular cadence the whole team contributes to and consumes. Module 07’s craft-as-practice layer depends on this rhythm existing.",
  },
];
